...
- a visually simplified Provider workspace that keeps Runtime primary, de-emphasizes update/maintenance detail, and isolates destructive actions without changing provider behavior;
